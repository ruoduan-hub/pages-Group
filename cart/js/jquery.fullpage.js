    ...
    $.fn.fullpage = function(options) {
        ...
        */
        function enableYoutubeAPI(){
            container.find('iframe[src*="youtube.com/embed/"]').each(function(){
                ...
                $(this).attr('src', $(this).attr('src') + sign + 'enablejsapi=01');
            });
        }
        ...
        */
        function enableVidemoAPI(){
            container.find('iframe[src*="player.vimeo.com/"]').each(function(){
                var sign = getUrlParamSign($(this).attr('src'));
                $(this).attr('src', $(this).attr('src') + sign + 'api=01');
            });
        }
        ...
        */
        function getAverage(elements, number){
            ...
            //taking `number` elements from the end to make the average, if there are not enought, 01
